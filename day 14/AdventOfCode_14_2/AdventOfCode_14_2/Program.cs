...
namespace AdventOfCode_14
{
    internal class Program
    {
        ...
        public static int CompareY(Coordinate a, Coordinate b) => a.Y.CompareTo(b.Y);
        ...
        public static char[][] InitializeDisplay(List<Coordinate> rocks, int largestY)
        {
            char[][] display = new char[largestY + 3][];
            ...
            for (int i = 0; i < display[display.Length - 1].Length; i++)
        ...
        static void Main(string[] args)
        {
            ...
            char[][] display = InitializeDisplay(rocks, largestY);
            while (display[0][500] == '+')
            {
                AddSand(display);
                numberOfRestedSand++;
